...
function patchDynamicToolStartResponse(source, patch = findDynamicToolStartResponsePatch(source)) {
  ...
  const helper = source.includes(dynamicToolStartResponseMarker)
    ? ""
    : [
        `function ${dynamicToolStartResponseMarker}(e){return __codexLinuxCanonicalDynamicTools(e)}function __codexLinuxCanonicalDynamicToolFunction(e){if(e==null||typeof e!==\`object\`||typeof e.name!==\`string\`||e.type!=null&&e.type!==\`function\`)return null;let t=e.inputSchema??e.input_schema??e.parameters;if(t==null)return null;let n=e.deferLoading??(e.exposeToContext==null?!1:!e.exposeToContext);return{type:\`function\`,name:e.name,description:typeof e.description===\`string\`?e.description:\`\`,inputSchema:t,...n?{deferLoading:!0}:{}}}function __codexLinuxCanonicalDynamicTools(e){if(!Array.isArray(e))return[];let t=[],n=new Map,r=(e,o=null,i=\`\`)=>{if(e?.type===\`namespace\`&&Array.isArray(e.tools)){let a=typeof e.name===\`string\`?e.name:o;if(a==null)return;for(let t of e.tools)r(t,a,typeof e.description===\`string\`?e.description:\`\`);return}let a=__codexLinuxCanonicalDynamicToolFunction(e);if(a==null)return;let s=o??(typeof e.namespace===\`string\`?e.namespace:null);if(s==null){t.push(a);return}let l=n.get(s);if(l==null){l={type:\`namespace\`,name:s,description:i,tools:[]},n.set(s,l),t.push(l)}l.tools.push(a)};for(let n of e)r(n);return t}`
      ].join("");
...
function patchDynamicToolThreadStartBridge(source, patch = findDynamicToolThreadStartBridgePatch(source)) {
  ...
  const helper = source.includes(dynamicToolThreadStartBridgeMarker)
    ? ""
    : [
        `function ${dynamicToolThreadStartBridgeMarker}(e){if(e?.method!==\`thread/start\`||e.params==null||!Array.isArray(e.params.dynamicTools))return e;return{...e,params:{...e.params,dynamicTools:__codexLinuxCanonicalThreadStartBridgeDynamicTools(e.params.dynamicTools)}}}`,
        `function __codexLinuxCanonicalThreadStartBridgeFunction(e){if(e==null||typeof e!==\`object\`||typeof e.name!==\`string\`||e.type!=null&&e.type!==\`function\`)return null;let t=e.inputSchema??e.input_schema??e.parameters??{type:\`object\`,properties:{},additionalProperties:!1},n=e.deferLoading??(e.exposeToContext==null?!1:!e.exposeToContext);return{type:\`function\`,name:e.name,description:typeof e.description===\`string\`?e.description:\`\`,inputSchema:t,...n?{deferLoading:!0}:{}}}`,
        `function __codexLinuxCanonicalThreadStartBridgeDynamicTools(e){let t=[],n=new Map,r=(e,o=null,i=\`\`)=>{if(e?.type===\`namespace\`&&Array.isArray(e.tools)){let a=typeof e.name===\`string\`?e.name:o;if(a==null)return;for(let t of e.tools)r(t,a,typeof e.description===\`string\`?e.description:\`\`);return}let a=__codexLinuxCanonicalThreadStartBridgeFunction(e);if(a==null)return;let s=o??(typeof e.namespace===\`string\`?e.namespace:null);if(s==null){t.push(a);return}let l=n.get(s);if(l==null){l={type:\`namespace\`,name:s,description:i,tools:[]},n.set(s,l),t.push(l)}l.tools.push(a)};for(let t of e)r(t);return t}`
      ].join("");
  const replacements = patch.patches.map(target => {
...
function patchDynamicToolThreadStartRequest(source, patch = findDynamicToolThreadStartRequestPatch(source)) {
  ...
  const helper = source.includes(dynamicToolThreadStartRequestMarker)
    ? ""
    : [
        `function ${dynamicToolThreadStartRequestMarker}(e){if(e==null||!Array.isArray(e.dynamicTools))return e;return{...e,dynamicTools:__codexLinuxCanonicalThreadStartRequestDynamicTools(e.dynamicTools)}}function __codexLinuxCanonicalThreadStartRequestFunction(e){if(e==null||typeof e!==\`object\`||typeof e.name!==\`string\`||e.type!=null&&e.type!==\`function\`)return null;let t=e.inputSchema??e.input_schema??e.parameters??{type:\`object\`,properties:{},additionalProperties:!1},n=e.deferLoading??(e.exposeToContext==null?!1:!e.exposeToContext);return{type:\`function\`,name:e.name,description:typeof e.description===\`string\`?e.description:\`\`,inputSchema:t,...n?{deferLoading:!0}:{}}}function __codexLinuxCanonicalThreadStartRequestDynamicTools(e){let t=[],n=new Map,r=(e,o=null,i=\`\`)=>{if(e?.type===\`namespace\`&&Array.isArray(e.tools)){let a=typeof e.name===\`string\`?e.name:o;if(a==null)return;for(let t of e.tools)r(t,a,typeof e.description===\`string\`?e.description:\`\`);return}let a=__codexLinuxCanonicalThreadStartRequestFunction(e);if(a==null)return;let s=o??(typeof e.namespace===\`string\`?e.namespace:null);if(s==null){t.push(a);return}let l=n.get(s);if(l==null){l={type:\`namespace\`,name:s,description:i,tools:[]},n.set(s,l),t.push(l)}l.tools.push(a)};for(let t of e)r(t);return t}`
      ].join("");
  const replacements = patch.patches.map(target => {
...
function patchDynamicToolSchemaContract(source, patch = findDynamicToolSchemaContractPatch(source)) {
  ...
  const helper = source.includes(dynamicToolSchemaContractMarker)
    ? ""
    : [
        `function ${dynamicToolSchemaContractMarker}(e){if(e==null||e.type!==\`function\`||typeof e.name!==\`string\`)return null;let t=e.inputSchema??e.input_schema??e.parameters;if(t==null)return null;return{type:\`function\`,name:e.name,description:typeof e.description===\`string\`?e.description:\`\`,inputSchema:t,...e.deferLoading?{deferLoading:!0}:{}}}`
      ].join("");
  const replacements = [];
